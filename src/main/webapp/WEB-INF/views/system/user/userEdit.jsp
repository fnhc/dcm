...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-6">
                    <form role="form" data-validator-option="{theme:'bootstrap', timely:2, stopOnError:true}" method="post" action="/system/user/doEdit">
                        <input id="userId" type="hidden" value="${id}" name="Id" />
                        <div class="box-body">
                            <div class="form-group">
                                <label for="userName">用户名</label>
                                <input type="text" id="userName" name="userName" class="form-control"
                                       placeholder="请输入用户名" data-rule="用户名:required;userName;remote(/system/user/editCheckName?userId=${id})">
                            </div>
                            <div class="form-group">
