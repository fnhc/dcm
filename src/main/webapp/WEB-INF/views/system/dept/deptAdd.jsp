                ...
                <div class="col-md-6">
                    <form role="form" data-validator-option="{theme:'bootstrap', timely:2, stopOnError:true}"
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="deptName" name="deptName" class="form-control"
                                       placeholder="请输入组织机构名称" data-rule="组织机构名称:required;simpleName;remote(/system/dept/checkDeptName);">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="box-footer">
                            <button class="btn btn-success" onclick="testFunc()"><i class="fa fa-save"></i>  提 交</button>
